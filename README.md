...
This repository is a hands-on code implementation based on the excellent architectural breakdown and guidelines from this technical article: [Habr - Gameplay Ability System Guide](https://habr.com).
